...
- [docs/runbooks/](runbooks/) — operational runbooks, including blob reconciliation, deployment, authenticated storage caching, CDN view counting, edge upload observability, and Fastly 5xx diagnostics
