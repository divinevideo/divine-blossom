...
- [docs/runbooks/](runbooks/) — operational runbooks, including blob reconciliation, deployment and rollback, outer VCL snippet sync, authenticated storage caching, private moderation cache smoke coverage, CDN view counting, edge upload observability, Fastly 5xx diagnostics, and cleanup of erased media at edge POPs
