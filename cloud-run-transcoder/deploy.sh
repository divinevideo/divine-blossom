...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-secrets "WEBHOOK_SECRET=webhook_secret:latest,TRANSCRIPTION_API_KEY=openai_api_key:latest,SENTRY_DSN=${SENTRY_SECRET}:latest,TRANSCRIBE_SHARED_SECRET=transcribe_shared_secret:latest"
